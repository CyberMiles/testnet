...
// For every 10s, each of the accounts will stake 10 ECs to a random node.
// If a node reaches 100,000 EC stake, an error will be thrown and we will ignore that error.
